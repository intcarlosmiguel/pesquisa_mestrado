...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \draw[->] (10,1) -- node[above] {$\phi$} (11.9,1);
    \draw[->] (13.5,0.5) -- node[above] {$\delta^i$} (15,-0.9);
    \draw[->] (12.5,0.5) -- node[below,rotate=32] {$\gamma_H$} (11,-0.9);
    \draw[->] (9,1) -- node[below,rotate=-38] {$\gamma_I$} (10.8,-0.9);
